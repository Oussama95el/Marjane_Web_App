...
<nav class="w-24 flex flex-col justify-between items-center bg-white">
    ...
    <ul class="mt-2 text-gray-700 dark:text-gray-400 capitalize">
        ...
        <li class="mt-3 p-2 hover:text-blue-600 dark-hover:text-blue-300 rounded-lg">
            <a href="/super-admin/dashboard" class=" flex flex-col items-center">
        ...
        <li
				...
				rounded-lg">
            <a href="/super-admin/promotions" class=" flex flex-col items-center" id="promotionManager">
        ...
        <li
            ...
            <a href="/super-admin/manager" class=" flex flex-col items-center" id="managers">
                ...
                <span class="text-xs mt-2">Manager</span>
            </a>
        </li>
